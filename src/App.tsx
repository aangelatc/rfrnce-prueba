    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="sticky top-0 z-30 border-b border-slate-800/80 bg-slate-950/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div className="text-lg font-semibold tracking-[0.2em] text-white">rfrnce</div>
          <nav className="hidden items-center gap-8 text-sm uppercase tracking-[0.25em] text-slate-400 md:flex">
            <a href="#que-es" className="transition hover:text-white">Qué es</a>
            ...
            <a href="#acceso" className="text-white transition hover:text-slate-200">Acceso anticipado</a>
          </nav>
          <a
            href="#acceso"
            className="rounded-full border border-slate-600 bg-white/5 px-5 py-2 text-xs uppercase tracking-[0.2em] text-slate-100 transition hover:bg-white/10"
          >
            Únete a la lista
          </a>
        </div>
      ...
      <main>
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="grid gap-16 xl:grid-cols-[1.2fr_0.8fr]">
              <div className="max-w-2xl space-y-8">
                <p className="inline-flex rounded-full border border-slate-700 bg-slate-900/70 px-4 py-1 text-xs uppercase tracking-[0.3em] text-slate-400">
                  Archivo creativo</p>
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  ...
                  <a
                    href="#como-funciona"
                    className="inline-flex items-center justify-center rounded-full border border-slate-700 bg-transparent px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-slate-500"
                  >
                    Ver cómo funciona
                  </a>
                </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[...Array(4)].map((_, index) => (
                  <div key={index} className="rounded-3xl border border-slate-800/90 bg-slate-900/70 p-6 shadow-glow backdrop-blur">
                    <div className="h-40 rounded-3xl bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950" />
        ...
        <section id="problema" className="border-t border-slate-800 px-6 py-20 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-400">El problema</p>
                ...
                <ul className="mt-8 grid gap-3 text-slate-300 sm:grid-cols-2">
                  {[
                    ...
                    <li key={item} className="rounded-2xl border border-slate-800 bg-slate-950/80 px-4 py-3 text-sm">
                      {item}
                    </li>
                  ))}
                </ul>
              </div>
              <div className="rounded-4xl border border-slate-800 bg-slate-950/80 p-8 shadow-glow">
                <div className="aspect-[4/5] overflow-hidden rounded-[2rem] border border-slate-800 bg-slate-900">
                  <div className="bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.18),transparent_25%),radial-gradient(circle_at_70%_20%,rgba(168,85,247,0.15),transparent_25%)] h-full p-6">
                    <div className="grid h-full gap-4">
                      ...
                      <div className="grid gap-4 rounded-3xl bg-slate-800/90 p-4">
                        {[...Array(3)].map((_, index) => (
                          <div key={index} className="h-12 rounded-2xl bg-slate-900/80" />
                        ))}
                      </div>
                      <div className="mt-auto grid gap-3">
                        {[...Array(4)].map((_, index) => (
                          <div key={index} className="h-14 rounded-3xl bg-slate-900/80" />
                        ))}
                      </div>
                    </div>
                  </div>
        ...
        <section id="que-es" className="px-6 py-20 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-16 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Qué es</p>
                <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {features.map((feature) => (
                  <div key={feature.title} className="rounded-3xl border border-slate-800 bg-slate-900/80 p-6 text-slate-300">
        ...
        <section id="como-funciona" className="border-t border-slate-800 px-6 py-20 md:py-24">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                <div key={item.step} className="rounded-3xl border border-slate-800 bg-slate-900/80 p-8 text-slate-300">
                  <div className="flex h-14 w-14 items-center justify-center rounded-3xl bg-slate-800 text-2xl font-semibold text-slate-200">
                    {item.step}
                  </div>
        ...
        <section id="para-quien" className="px-6 py-20 md:py-24">
          <div className="mx-auto max-w-6xl">
            <div className="grid gap-12 lg:grid-cols-[1fr_0.9fr] lg:items-center">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Para quién</p>
                <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  <div key={item} className="rounded-3xl border border-slate-800 bg-slate-950/80 px-6 py-8 text-slate-300">
                    <p>{item}</p>
                  </div>
                ))}
              </div>
        ...
        <section id="acceso" className="border-t border-slate-800 px-6 py-20 md:py-24">
          <div className="mx-auto max-w-4xl">
            <div className="rounded-[2rem] border border-slate-800 bg-slate-950/85 p-10 shadow-glow">
              <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Acceso anticipado</p>
                  <h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">
                    Únete a la lista de espera.
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="rounded-[1.75rem] border border-slate-800 bg-slate-900/90 p-8">
                  ...
                  <input
                    ...
                    className="mt-3 w-full rounded-2xl border border-slate-700 bg-slate-950 px-4 py-4 text-sm text-slate-100 outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-500/30"
                  />
                  <button
                    type="submit"
                    className="mt-6 w-full rounded-full bg-slate-100 px-6 py-4 text-sm font-semibold text-slate-950 transition hover:bg-slate-200"
                  >
                    Enviar solicitud
                  </button>
                  {status === "success" && (
